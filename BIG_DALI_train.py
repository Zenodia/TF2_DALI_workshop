...
class Opt3Pipeline(Pipeline):
    def __init__(self, img_file_list,  num_shards, shard_id, batch_size, num_threads, device_id):
        ...
        self.rotate = ops.Rotate(device = "gpu", angle = 30, interp_type = types.INTERP_LINEAR, fill_value = 0) # one can indicate what other fill_value you want
...
batch_size=2
pipe4 = Opt3Pipeline("bigimgs_path.txt", 2, 0, batch_size, 8, 0)
